...
<body>
    ...
    <?php else : ?>
        ...
        <div class="col-7" style="margin: auto;  padding: 2rem; border-radius: 15px; border: 1px solid black;">
            ...
            <hr class="mb-5">
            <form action="http://localhost/php-bank-v1/actions/updateAfterDeduct.php?id=<?= $accounts[$userId]['id'] ?>" method="post">
                <div class="form-group mt-3">
                    ...
                    <div hidden class="fundsInAccount"><?= $accounts[$userId]['balance'] ?></div>
                    <div class="messageAboutFunds hiddenMessage">You can't withdraw more than: € <?= $accounts[$userId]['balance'] ?></div>
                </div>
